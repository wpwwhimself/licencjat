...
Podczas gdy rozmiar testu opisuje prawdopodobieństwo popełnienia błędu przez test statystyczny, moc testu mówi o jego poprawności. Wysoka moc testu świadczy o tym, że odrzucenie hipotezy zerowej -- jeśli nastąpi -- jest uzasadnione. Zgodnie z ideą weryfikacji hipotez, dąży się do minimalizacji błędu II rodzaju, a w konsekwencji do maksymalizacji mocy testów statystycznych.
...
Symulacje wskazują na wysoką moc rozpatrywanych testów, szczególnie rozpatrując błąd lognormalny. Na szczególną uwagę zasługuje model M7, w którym we wszystkich przypadkach testy osiągają stuprocentową moc. Znaczy to, że wykorzystanie każdego z przedstawionych w tej pracy testów statystycznego jest uzasadnione do badania zależności między dwoma próbami zależnymi danych funkcjonalnych.
