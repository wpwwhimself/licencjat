...
Przy takim założeniu eksperymentu, otrzymane dane \textcolor{blue}{stanowią zależne dane funkcjonalne. Porównanie średnich funkcji w obu grupach to problem dwóch prób zależnych.} Do powyższych danych można zatem zastosować omawiane testy statystyczne. Wyniki tychże przedstawia \textcolor{blue}{Tabela \ref{tab:orteza-testy}.}
...
Na podstawie \textcolor{blue}{Rysunku} \@ref(fig:orteza-dane) można jednak zauważyć, że funkcje średnie mogą być równe w ostatniej fazie eksperymentu, tj. dla $t\in[0,8; 1]\cup[1,8; 2]$. Dla tak zmodyfikowanych danych (patrz \textcolor{blue}{Rysunek} \@ref(fig:orteza-dane-short)) przeprowadzono ponownie wszystkie cztery testy, a otrzymane wyniki zebrano w \textcolor{blue}{Tabeli} \@ref(tab:orteza-testy-short).
...
Wyniki testów dla zmodyfikowanych danych nie dają podstaw do odrzucenia hipotezy o równości funkcji -- wobec tego \textcolor{blue}{można twierdzić}, że w ostatniej fazie eksperymentu moment siły jest równy dla wszystich pacjentów niezależnie od rodzaju używanej ortezy.
